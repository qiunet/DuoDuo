...
public final class LoginProto {
  ...
  public  static final class FightStart extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return LoginProto.internal_static_FightStart_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return LoginProto.internal_static_FightStart_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              LoginProto.FightStart.class, LoginProto.FightStart.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof LoginProto.FightStart)) {
        return super.equals(obj);
      }
      LoginProto.FightStart other = (LoginProto.FightStart) obj;
    ...
    public static LoginProto.FightStart parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static LoginProto.FightStart parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static LoginProto.FightStart parseFrom(
    ...
    public static LoginProto.FightStart parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static LoginProto.FightStart parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static LoginProto.FightStart parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(LoginProto.FightStart prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
        ...
        LoginProto.FightStartOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return LoginProto.internal_static_FightStart_descriptor;
      }
      ...
      public LoginProto.FightStart getDefaultInstanceForType() {
        return LoginProto.FightStart.getDefaultInstance();
      }

      public LoginProto.FightStart build() {
        LoginProto.FightStart result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public LoginProto.FightStart buildPartial() {
        LoginProto.FightStart result = new LoginProto.FightStart(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof LoginProto.FightStart) {
          return mergeFrom((LoginProto.FightStart)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(LoginProto.FightStart other) {
        if (other == LoginProto.FightStart.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        LoginProto.FightStart parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (LoginProto.FightStart) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final LoginProto.FightStart DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new LoginProto.FightStart();
    }

    public static LoginProto.FightStart getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

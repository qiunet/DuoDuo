...
public class TestProtobufData {
	...
	public void testParamCheck() {
		ParamCheckList paramCheckList = ChannelDataMapping.paramCheckList(WsPbLoginRequest.class);
		Assertions.assertNotNull(paramCheckList);

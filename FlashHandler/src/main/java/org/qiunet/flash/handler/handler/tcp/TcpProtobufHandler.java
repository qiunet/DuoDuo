 ...
 * 17/7/21
 */
public abstract class TcpProtobufHandler<P extends IPlayerActor, RequestData extends IpbRequestData> extends BaseHandler<RequestData> implements ITcpHandler<P, RequestData> {

 ...
 * 17/11/21
 */
class FacadeAsyncHttpRequest<RequestData, ResponseData> implements IAsyncHttpRequest<RequestData, ResponseData> {
	private IHttpRequestContext<RequestData, ResponseData> context;

	public FacadeAsyncHttpRequest(IHttpRequestContext context) {

 ...
 * 17/12/2
 */
public class WebSocketStringRequestContext<P extends IPlayerActor> extends AbstractWebSocketRequestContext<String, String, P> {
	...
	public void handlerRequest() {
		FacadeWebSocketRequest<String, String, P> facadeWebSocketRequest = new FacadeWebSocketRequest<>(this);
		try {

...
public class LoginRoomHandler extends TcpProtobufHandler<PlayerActor, LoginRoomRequest> {

	@Override
	public void handler(PlayerActor playerActor, ITcpRequest<LoginRoomRequest> context) throws Exception {

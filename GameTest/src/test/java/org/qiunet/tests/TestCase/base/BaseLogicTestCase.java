 ...
 * 17/12/9
 */
public abstract class BaseLogicTestCase<RequestData extends IpbRequestData, ResponseData extends IpbChannelData> extends HttpProtobufTestCase<RequestData, ResponseData, Robot> {

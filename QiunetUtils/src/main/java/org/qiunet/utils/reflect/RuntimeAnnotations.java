...
public final class RuntimeAnnotations {
    ...
    private static <T extends Annotation> Object createAnnotationData(Class<?> c, Object annotationData, Class<T> annotationClass, T annotation, int classRedefinedCount) throws Exception {

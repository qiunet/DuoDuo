...
import org.qiunet.data.core.mongo.pojo.DPojoCodecProvider;
import org.qiunet.data.core.mongo.provide.DMapCodecProvider;
...
public final class MongoDbSupport {
	...
	private static MongoDbClient createMongodbClient(String dbSource) {
		...
		MongoDbClient mongoDbClient = new MongoDbClient(clientSettings, connectionString);
		ShutdownHookUtil.getInstance().addLast(mongoDbClient::close);

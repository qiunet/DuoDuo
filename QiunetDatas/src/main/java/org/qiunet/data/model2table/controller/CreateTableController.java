package org.qiunet.data.model2table.controller;
...
import org.qiunet.data.model2table.command.CreateTableParam;
...
public class CreateTableController {
	...
	public void start() {
		...
		if ("insert".equals(initData)) {
			...
			Integer dataCount = createTableService.getTableCount(DbProperties.getInstance().getDataSourceKeyByDbIndex(0));
			if (dataCount > 0) {
